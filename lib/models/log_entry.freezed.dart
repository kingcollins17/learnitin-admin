...
mixin _$LogEntry {
 ...
 int? get id; String? get level; String? get message; Map<String, dynamic>? get data;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,level,message,const DeepCollectionEquality().hash(data),createdAt);

@override
String toString() {
  return 'LogEntry(id: $id, level: $level, message: $message, data: $data, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int? id, String? level, String? message, Map<String, dynamic>? data,@JsonKey(name: 'created_at') DateTime? createdAt
});
...
/// Create a copy of LogEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? level = freezed,Object? message = freezed,Object? data = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? level,  String? message,  Map<String, dynamic>? data, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LogEntry() when $default != null:
return $default(_that.id,_that.level,_that.message,_that.data,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? level,  String? message,  Map<String, dynamic>? data, @JsonKey(name: 'created_at')  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _LogEntry():
return $default(_that.id,_that.level,_that.message,_that.data,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? level,  String? message,  Map<String, dynamic>? data, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _LogEntry() when $default != null:
return $default(_that.id,_that.level,_that.message,_that.data,_that.createdAt);case _:
  return null;
...
class _LogEntry implements LogEntry {
  const _LogEntry({this.id, this.level, this.message, final  Map<String, dynamic>? data, @JsonKey(name: 'created_at') this.createdAt}): _data = data;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,level,message,const DeepCollectionEquality().hash(_data),createdAt);
...
/// Create a copy of LogEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? level = freezed,Object? message = freezed,Object? data = freezed,Object? createdAt = freezed,}) {
