    ...
    return div(classes: 'card overflow-hidden', [
      ...
      div(classes: 'flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4', [
        div(classes: 'flex flex-wrap items-center gap-3 w-full md:w-auto', [
          ...
          select(
            ...
            [
              option(value: '', [Component.text('All Categories')]),
              option(value: 'Web Dev', [Component.text('Web Development')]),
              option(value: 'Mobile', [Component.text('Mobile Dev')]),
              option(value: 'Data Science', [Component.text('Data Science')]),
              option(value: 'Design', [Component.text('Design')]),
              option(value: 'Business', [Component.text('Business')]),
            ],
          ),
      ...
      coursesAsync.when(
        ...
        error: (e, st) => div(classes: 'p-12 text-center bg-red-500/5 rounded-2xl border border-red-500/10', [
          ...
          p(classes: 'text-dark-muted mb-6 max-w-md mx-auto', [Component.text(e.toString())]),
          button(
            classes:
                ...
                tr(classes: 'border-b border-dark-border/40 hover:bg-white/[0.03] transition-all group', [
                  ...
                  td(classes: 'py-5 px-6', [
                    div(classes: 'flex items-start space-x-4', [
                      div(
                        ...
                        [Component.text(_getEmojiForCategory(course.category))],
                      ),
                      div(classes: 'min-w-0', [
                  ...
                  td(classes: 'py-5 px-6', [
                    span(
                      ...
                      [Component.text(course.category ?? 'Uncategorized')],
                    ),
                  ]),
                  ...
                  td(classes: 'py-5 px-6', [
                    div([
                      p(classes: 'text-sm font-bold text-white', [
                        Component.text((course.enrollments ?? 0).toString()),
                      ]),
                    ...
                    div(classes: 'space-y-1.5', [
                      div(classes: 'flex items-center justify-between min-w-[120px]', [
                        ...
                        span(classes: 'text-xs font-bold text-amber-400', [
                          Component.text('⭐ ${course.rating ?? 0.0}'),
                        ]),
                      ]),
                      div(classes: 'w-full h-1.5 bg-dark-border rounded-full overflow-hidden', [
                        div(
                          classes:
                              'h-full rounded-full bg-gradient-to-r from-primary-600 to-primary transition-all duration-700',
                          styles: Styles(raw: {'width': '${((course.completionRate ?? 0.0) * 100).round()}%'}),
                          [],
                        ),
                      ]),
                      div(classes: 'flex items-center justify-between', [
                        span(classes: 'text-[10px] text-dark-muted', [Component.text('Completion')]),
                        span(classes: 'text-[10px] font-bold text-white', [
                          Component.text('${((course.completionRate ?? 0.0) * 100).round()}%'),
                        ]),
                      ]),
                    ]),
                  ]),
